...
const TodoAddItem = ({setAddFunc, setEditFunc, isEdit, addItemFunc, editItemFunc, changeTodo, removeFunc}) => {
	...
	return(
		<div className='todo_add'>
			...
			<div className='todo_add__btns'>
				...
				<Button func={isEdit ? setEditFunc : setAddFunc} styles={{background: '#00d9ff'}}>Отмена</Button>
			</div>
		</div>
	)
}
